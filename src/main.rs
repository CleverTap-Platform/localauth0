...
fn setup_service(cfg: &mut web::ServiceConfig) {
    cfg.service(controller::healthcheck)
        ...
        .service(controller::authorize)
        .service(controller::login_page)
        .service(controller::login_identifier)
        .service(controller::login_password)
        .service(controller::authorize_resume)
